	...
	getMission: function() {
		...
		if ( this.props.charity.mission ) {
			return 	<p className='charity-mission'>
						...
						<Link text='Learn More' href={url}/>.
					</p>
		} else {
			return 	<p className='charity-mission'>
						No mission statement is available for {this.props.charity.formattedName}. <Link text='Learn more about this organization' href={url}/>.
					</p>
		}
	},
