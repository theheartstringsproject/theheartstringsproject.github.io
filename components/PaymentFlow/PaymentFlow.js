	...
	getPageComponentForKey: function( key ) {
		...
		switch( key ) {
			...
			case 'ConfirmationPage':
				return <ConfirmationPage charityName={charityName} amount={amount} email={email.value} cardNumber={cardNumber.formattedValue} cardCursorPosition={cardCursorPosition} key={key}/>
			case 'LoadingPage':
